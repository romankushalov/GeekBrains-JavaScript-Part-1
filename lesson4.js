...
function countBs (str) { //Объявление функции
  ...
  return (charBs); //Вывод количества искомого символа
}
...
function countChar (str, char) { //Объявление функции
  ...
  return (charCount); //Вывод количества искомого символа
}
...
if (n == 0 || n == 1) { //Условие ИЛИ для дальнейшей проверки (в таком виде срабатывает для любых чисел
